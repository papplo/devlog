    ...
    var typology_app = {
        ...
        align_full_fix: function() {
            ...
            if (!$('body').hasClass('typology-flat')) {
                style = '.alignfull { max-width: ' + $('.typology-section').outerWidth() + 'px; -webkit-transform: translateX(-50%); -ms-transform: translateX(-50%); transform: translateX(-50%); width: 100vw; left: 50%; }';
